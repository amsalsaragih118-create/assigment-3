...
**Cara Kerja Program**
1.Pengguna memasukkan jumlah segitiga.
2.Untuk setiap segitiga, pengguna memasukkan tiga titik (x, y).
3.Program menghitung panjang sisi dari ketiga titik tersebut.
4.Berdasarkan panjang sisi, program menentukan jenis segitiga:
